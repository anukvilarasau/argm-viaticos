...
type PlanningControlPanelProps = {
  canExport: boolean;
  canImport: boolean;
  email: string | null;
  goalCount: number;
...
export function PlanningControlPanel({
  ...
  return (
    <View className="w-full gap-4" style={{ maxWidth: 316, flexShrink: 1 }}>
      <View className="rounded-[28px] border border-white/45 bg-white/74 p-4 shadow-sm">
        <Text className="text-sm font-medium uppercase tracking-[1.5px] text-text/70">Carga rápida</Text>
      ...
      <View className="rounded-[28px] border border-white/45 bg-white/74 p-4 shadow-sm">
        <Text className="text-sm font-medium uppercase tracking-[1.5px] text-text/70">Objetivos y sincronización</Text>

        <View className="mt-4 rounded-[22px] bg-white/76 p-4">
        ...
        <View className="mt-4 rounded-[22px] bg-[#F5F2FF] p-4">
